...
public class JsWindowOpenImpl2 extends WebChromeClient {

    volatile WebView newWebView;
  public   IWebViewInit webViewInit;
   volatile DefaultWebActivity fullScreenActivity;
            ...
            new Handler().post(new Runnable() {
                ...
                public void run() {
                    try {
                        ...
                        WebviewHolder holder = initView(view.getContext(), newWebView);
                            ...
                            StartActivityUtil.startActivity(compatActivity,
                                    ...
                                    false, new TheActivityListener<DefaultWebActivity>(){
                                        ...
                                        protected void onActivityCreated(@NonNull DefaultWebActivity activity, @Nullable Bundle savedInstanceState) {
                                            ...
                                            activity.setContent(holder.root);
                                            activity.agentWeb = holder.agentWeb;
                                            activity.holder = holder;
                                            holder.activity = activity;
                                            holder.impl2.fullScreenActivity = activity;
    ...
    private WebviewHolder initView(Context context, WebView webView) {
